    ...
    <div className="container">
      <div className="columns">
        <div className="column">
          <div className="columns">
            <div className="column">
              <span className="is-size-1">Terms And Conditions</span>
            </div>
          </div>
          <div className="columns">
            <div className="column">
      ...
      <div className="columns">
        <div className="column">
          <div className="container">
            <div className="columns">
              <div className="column">
                <span className="is-size-4">OVERVIEW</span>
              </div>
            </div>
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  This website is operated by Create. Throughout the site, the
                  terms “we”, “us” and “our” refer to Create. Create offers this
                  ...
                  stated here. By visiting our site and/ or purchasing something
                  from us, you engage in our “Service” and agree to be bound by
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  ...
                  read these Terms of Service carefully before accessing or
                  ...
                  expressly limited to these Terms of Service. Any new features
                  or tools which are added to the current store shall also be
                  subject to the Terms of Service. You can review the most
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  ...
                  these Terms of Service by posting updates and/or changes to
                  ...
                  acceptance of those changes. Our store is hosted on Shopify
                  Inc. They provide us with the online e-commerce platform that
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  ...
                  display of any color will be accurate.We reserve the right,
                  but are not obligated, to limit the sales of our products or
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  ...
                  appear to be placed by dealers, resellers or distributors.You
                  ...
                  including your email address (if applicable) and decentralized
                  wallet addresses, so that we can complete your transactions
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-4">SECTION 7 - OPTIONAL TOOLS</span>
              </div>
            </div>
            <div className="columns">
              <div className="column">
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-4">SECTION 8 - THIRD-PARTY LINKS</span>
              </div>
            </div>
            <div className="columns">
              <div className="column">
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  ...
                  or otherwise unlawful, abusive or obscene material, or contain
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  ...
                  non-infringement.In no case shall Create, our directors,
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  You agree to indemnify, defend and hold harmless Create and
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  ...
                  to use our Services, or when you cease using our site.If in
                  our sole judgment you fail, or we suspect that you have
            ...
            <div className="columns">
              <div className="column">
                <span className="is-size-6">
                  ...
                  accordance with the laws of Castleboy, Auburn, Dublin Road,
                  Athlone, L, N37 PX83, Ireland.
                </span>
              </div>
            </div>
            <div className="columns">
